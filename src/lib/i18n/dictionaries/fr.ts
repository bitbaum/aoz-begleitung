...
export const fr: Dictionary = {
  ...
  'navGroup.living': 'Logement',
  'navGroup.community': 'Vie commune',
  'navGroup.concerns': 'Mes demandes',
  'navGroup.integration': 'Intégration',
  ...
  'care.statusRequested': 'Demandé',
  'care.statusScheduled': 'Confirmé',
  'care.statusCancelled': 'Annulé',
  'care.statusPast': 'Passé',
  'care.requestAsk': 'Demander un entretien',
  'care.requestWhen': 'Moment souhaité',
  'care.requestWhat': 'De quoi s’agit-il ? (facultatif)',
  'care.requestSubmit': 'Envoyer la demande',
  'care.requestAnswer': 'Réponse',
  'care.requestUnclaimed': 'Pas encore de réponse',
  ...
  'marketplace.natureGoods': 'Objets',
  'marketplace.natureService': 'Coups de main',
  'marketplace.kindOfferHelp': 'Je propose',
  'marketplace.kindNeedHelp': 'Je cherche de l’aide',
  'marketplace.claimTake': 'Je le prends',
  'marketplace.claimBorrow': 'Je l’emprunte',
  'marketplace.claimHaveOne': 'J’en ai un',
  'marketplace.claimAcceptHelp': 'Oui, volontiers',
  'marketplace.claimGiveHelp': 'Je vous aide',
  'marketplace.categoryTranslation': 'Traduction',
  'marketplace.categoryChildcare': 'Garde d’enfants',
  'marketplace.categoryMoving': 'Déménagement',
  'marketplace.categoryRepair': 'Réparations',
  'marketplace.categoryTutoring': 'Soutien scolaire',
  'marketplace.categoryCooking': 'Cuisine',
  ...
  'marketplace.mine': 'Vos annonces',
  'marketplace.emptyOpen': 'Rien d’ouvert pour le moment. Publiez quelque chose.',
  ...
  'dashboard.nothingDue': 'Rien en cours',
  'dashboard.nothingDueDesc': "Aucune tâche ne t'attend pour le moment.",
  ...
  'portal.title': 'Mon espace',
  'portal.titleHousehold': 'Mon chez-moi',
  ...
  'activities.categoryLanguage': 'Langue',
  'activities.categoryCulture': 'Culture',
  'activities.categoryCommunity': 'Communauté',
  'activities.categoryFamily': 'Famille',
  'activities.categorySupport': 'Soutien',
  'activities.costFree': 'Gratuit',
  'activities.costReduced': 'Tarif réduit',
  ...
  'opportunities.openEmpty':
    'Aucune place proposée pour l’instant. Votre équipe vous préviendra dès qu’il y en aura une.',
  'opportunities.express': 'Cela m’intéresse',
  ...
  'opportunities.errorUnavailable': 'Cette place n’est pas disponible actuellement.',
  'opportunities.errorFull': 'Cette place a été prise entre-temps.',
  'opportunities.errorLocked':
    'Votre équipe a déjà pris en charge cette candidature. Parlez-en à votre équipe si quelque chose a changé.',
  'opportunities.errorFailed': 'Cela n’a pas fonctionné. Veuillez réessayer plus tard.',
  ...
  'opportunities.stageAccepted': 'Accepté·e',
