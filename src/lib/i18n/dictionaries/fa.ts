...
export const fa: Dictionary = {
  ...
  'navGroup.living': 'روزمره و مسکن',
  'navGroup.together': 'با هم',
  'navGroup.integration': 'ادغام و کار',
  ...
  'dashboard.subtitle': 'همه چیز درباره اقامتگاهت در یک جا',
  'dashboard.housing': 'اقامتگاه تو',
  'dashboard.active': 'فعال',
  'dashboard.moveIn': 'تاریخ ورود',
  'dashboard.rooms': 'اتاق‌ها',
  'dashboard.roommatesCount': 'هم‌اتاقی‌ها',
  'dashboard.compatibility': 'سازگاری',
  'dashboard.houseRules': 'قوانین خانه',
  'dashboard.quietHours': 'ساعات سکوت',
  'dashboard.smokingAllowed': 'سیگار مجاز است',
  'dashboard.noSmoking': 'غیرسیگاری',
  'dashboard.petsAllowed': 'حیوانات خانگی مجاز',
  'dashboard.noPets': 'حیوان خانگی ممنوع',
  'dashboard.roommates': 'هم‌اتاقی‌ها',
  'dashboard.myReports': 'گزارش‌های تو',
  'dashboard.newReport': 'گزارش جدید',
  'dashboard.noReports': 'گزارشی وجود ندارد',
  'dashboard.now': 'اکنون',
  'dashboard.taskSingular': 'وظیفه نیاز به توجه دارد.',
  'dashboard.taskPlural': 'وظایف نیاز به توجه دارند.',
  'dashboard.nextDesc': 'مشکلات را زود گزارش بده و تنظیماتت را به‌روز نگه دار.',
  'dashboard.quickChores': 'وظایف',
  'dashboard.quickReport': 'گزارش مشکل',
  'dashboard.quickLearning': 'یادگیری',
  'dashboard.quickPreferences': 'تنظیمات',
  'dashboard.onboarding.title': 'پروفایل تو ساخته شد',
  'dashboard.onboarding.subtitle': 'ما به دنبال اقامتگاه مناسب برای تو هستیم',
  'dashboard.onboarding.completePreferences': 'تکمیل تنظیمات',
  'dashboard.onboarding.completePreferencesHint': 'هر چه بیشتر بدانیم، هم‌اتاقی‌های بهتری پیدا می‌کنیم.',
  'dashboard.onboarding.browseHousing': 'مرور اقامتگاه‌های موجود',
  'dashboard.onboarding.browseHousingHint': 'اقامتگاه‌هایی که با ترجیحاتت مطابقت دارند را ببین.',
  'dashboard.onboarding.step1': 'پروفایل ساخته شد',
  'dashboard.onboarding.step2': 'تکمیل تنظیمات',
  'dashboard.onboarding.step3': 'یافتن اقامتگاه',
  'dashboard.onboarding.step4': 'ورود',
  'dashboard.noHousingContact': 'با مددکار اجتماعی خود تماس بگیر.',
  'activities.dashboardTitle': 'فعالیت‌ها در زوریخ',
  'activities.dashboardSubtitle': 'پیشنهادهای رایگان و مقرون‌به‌صرفه',
  'activities.dashboardCta': 'همه پیشنهادها',
  'activities.noResults': 'در این دسته‌بندی فعالیتی یافت نشد.',
  'expenses.dashboardTitle': 'هزینه‌ها',
  'expenses.dashboardCta': 'همه هزینه‌ها',
  'expenses.dashboardBalance': 'موجودی تو',
  'expenses.balanceSettled': 'تسویه شده',
  'expenses.balancePositive': 'طلب دارد',
  'expenses.balanceNegative': 'بدهکار است',
  'satisfaction.title': 'حالت در اقامتگاه چطور است؟',
  'satisfaction.subtitle': 'بازخورد محرمانه‌ات به ما کمک می‌کند مشکلات را زود تشخیص دهیم',
  'satisfaction.privacyNote': 'محرمانه ذخیره می‌شود · به اسمت مرتبط نیست',
  'satisfaction.thankYouTitle': 'از بازخوردت متشکریم!',
  'satisfaction.thankYouMessage': 'بازخورد تو به ما کمک می‌کند اقامتگاه را بهبود دهیم',
  'satisfaction.concernsForwarded': 'نگرانی‌هایت را منتقل کردیم',
  'satisfaction.newFeedback': 'بازخورد جدید',
  'satisfaction.lastFeedback': 'آخرین بازخورد',
  'satisfaction.today': 'امروز',
  'reports.showAllCount': 'نمایش همه گزارش‌ها',
}
