...
export const ru: Dictionary = {
  ...
  'care.statusRequested': 'Запрошено',
  'care.statusScheduled': 'Подтверждено',
  'care.statusCancelled': 'Отменено',
  'care.statusPast': 'Прошло',
  'care.requestAsk': 'Запросить встречу',
  'care.requestWhen': 'Желаемое время',
  'care.requestWhat': 'О чём речь? (необязательно)',
  'care.requestSubmit': 'Отправить запрос',
  'care.requestAnswer': 'Ответ',
  'care.requestUnclaimed': 'Ответа пока нет',
  ...
  'dashboard.nothingDue': 'Ничего не открыто',
  'dashboard.nothingDueDesc': 'Сейчас тебя не ждёт ни одна задача.',
